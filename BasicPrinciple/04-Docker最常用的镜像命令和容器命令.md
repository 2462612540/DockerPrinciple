...
大家就可以学习 Docker 的镜像构建、备份恢复迁移、镜像仓库、网络、集群等等更多的内容。
　
----------------------------------------------------------------------------------------------------------
...
![Image text](../BasicPrinciple/images/0401.png)
...
![Image text](../BasicPrinciple/images/0402.png)
...
docker volume ls
```
![Image text](../BasicPrinciple/images/0403.png)
...
![](../BasicPrinciple/images/0404.png)
...
![Image text](../BasicPrinciple/images/0405.png)
　
#### 只读/读写
